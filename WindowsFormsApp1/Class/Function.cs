...
namespace WindowsFormsApp1.Class
{
    ...
    {
        public static SqlConnection con;  //Biến cục bộ, khai báo đối tượng kết nối
        public static string connect = "server = MSI ; database = QLBH ;integrated security = true";
        public static void Connect()
        {
            con = new SqlConnection(); // Khỏi tạo đối tượng
            con.ConnectionString= "server = MSI ; database = QLBH ;integrated security = true";
            // Kiểm tra kết nối
