...
namespace WindowsFormsApp1
{
    public partial class frmDanhMucHangHoa : Form
    {
        ...
        {
            string sql;
            sql = "SELECT * from tlbHang";
            tlbH = Function.GetDataToTable(sql);
            dgvHang.DataSource = tlbH;
...
private void dgvHang_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT Anh FROM tlbHang WHERE MaHang=N'" + txtMaHang.Text + "'";
            txbAnh.Text = Function.GetFieldValues(sql);
            picAnh.Image = Image.FromFile(txbAnh.Text);
            sql = "SELECT Ghichu FROM tlbHang WHERE MaHang = N'" + txtMaHang.Text + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaHang FROM tlbHang WHERE MaHang=N'" + txtMaHang.Text.Trim() + "'";
            ...
            sql = "INSERT INTO tlbHang(MaHang,TenHang,MaChatLieu,SoLuong,DonGiaNhap, DonGiaBan,Anh,Ghichu) VALUES(N'"
                + txtMaHang.Text.Trim() + "',N'" + txtTenHang.Text.Trim() +
                "',N'" + cboMaChatLieu.SelectedValue.ToString() +
                "'," + txtSoLuong.Text.Trim() + "," + txtDonGiaNhap.Text +
                "," + txtDonGiaBan.Text + ",'" + txbAnh.Text + "',N'" + txtGhiChu.Text.Trim() + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tlbHang SET TenHang=N'" + txtTenHang.Text.Trim().ToString() +
                "',MaChatLieu=N'" + cboMaChatLieu.SelectedValue.ToString() +
                "',SoLuong=" + txtSoLuong.Text +
                ",Anh='" + txbAnh.Text + "',Ghichu=N'" + txtGhiChu.Text + "' WHERE MaHang=N'" + txtMaHang.Text + "'";
            Function.RunSql(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE tlbHang WHERE MaHang=N'" + txtMaHang.Text + "'";
                Function.RunSql(sql);
                LoadDataGridView();
                ResetValues();
            }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT * from tlbHang WHERE 1=1";
            if (txtMaHang.Text != "")
            ...
            else MessageBox.Show("Có " + tlbH.Rows.Count + "  bản ghi thoả mãn điều kiện!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvHang.DataSource = tlbH;
            ResetValues();
        }
        ...
        {
            string sql;
            sql = "SELECT MaHang,TenHang,MaChatLieu,SoLuong,DonGiaNhap,DonGiaBan,Anh,Ghichu FROM tlbHang";
            tlbH = Function.GetDataToTable(sql);
            dgvHang.DataSource = tlbH;
        }
    }
