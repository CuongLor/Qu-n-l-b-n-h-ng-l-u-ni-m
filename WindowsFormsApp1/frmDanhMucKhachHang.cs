...
namespace WindowsFormsApp1
{
    public partial class frmDanhMucKhachHang : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            //Chèn thêm
            sql = "INSERT INTO tblKhach VALUES (N'" + txtMaKhach.Text + "',N'" + txtTenKhach.Text + "',N'" + txtDiaChi.Text + "','" + mtbDienThoai.Text + "')";
            Function.RunSql(sql);
            LoadDataGridView();
            ResetValues();
            btnXoa.Enabled = true;
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblKhach SET HoTen=N'" + txtTenKhach.Text.Trim().ToString() + "',DiaChi=N'" +txtDiaChi.Text.Trim().ToString() + "',SoDienThoai='" + mtbDienThoai.Text.ToString() + "' WHERE MaKhach=N'" + txtMaKhach.Text + "'";
            Function.RunSql(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
        ...
        private void dgvKhachHang_Click(object sender, EventArgs e)
        {
            ...
            txtTenKhach.Text = dgvKhachHang.CurrentRow.Cells["HoTen"].Value.ToString();
